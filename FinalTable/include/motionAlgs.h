...
extern void facePoint(float xTar, float yTar, bool fpSmooth, float speedLimit);
...
extern void faceAway(float xTar, float yTar, bool fpSmooth, float speedLimit);
extern void faceHeading(float tTar, bool fpSmooth, float speedLimit);
extern float rotKP;
extern float linKP;
...
extern float TProtKP;
extern float TProtKI;
